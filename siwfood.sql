...
INSERT INTO cuochi (id, utente_id) VALUES (nextval('cuochi_seq'), 51);

INSERT INTO ricette (id, nome, descrizione, immagini, cuoco_id) VALUES
    (nextval('ricette_seq'), 'Pasta', 'Una bella pasta al sugo.', '{"/images/ricette/1/pasta_1.jpeg", "/images/ricette/1/pasta_2.jpeg"}', 1);
